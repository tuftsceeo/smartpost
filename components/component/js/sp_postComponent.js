...
var sp_postComponent = {
	...
	makeWidgetDraggable: function(sortableElem){
	  ...
	  $('.catComponentWidget').click(function(){
				//var catCompID = $(this).attr("data-compid");
				//var typeID    = $(this).attr("data-typeid");
				//thisObj.addNewComponent(catCompID, typeID);
	  })
	...
	addNewComponent: function(catCompID, typeID, postID, componentStack, compHandler){	
		...
		$.ajax({
				url				  : ajaxurl,
				type     : 'POST',
				data			  : {action      : 'newPostComponentAJAX', 
																nonce       : spNonce,  
																catCompID   : catCompID,
																postID      : postID
																},
	...
	setCompOrder: function(components, postID){
			...
			$.ajax({
					url				  : ajaxurl,
					type     : 'POST',
					data			  : {action      : 'setPostCompOrderAJAX', 
																	nonce       : spNonce,  
																	compOrder   : compOrder,
																	postID      : postID
																	},
