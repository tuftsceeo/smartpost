...
sp_widgets.sp_postTreeWidget = {
    /**
     * AJAX function used to relocate a post to a different category.
     * Updates the post's parent ID as well as it's category.
     * Calls relocatePostAJAX() in sp_postTreeWidgetAJAX class.
     * @param parentID
     * @param postID
     * @param catID
     */
